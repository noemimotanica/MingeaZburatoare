...
public class Masina {
    ...
    //acces control : private= este disponibil doar in acesta clasa unde e declarat
    // incapsularea=conceptul prin care excludem atributele de tot ce le inconjoara
   //polimorfism static la exterior si dinamic la interior
